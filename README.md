...
<br>This is a little url that executes javascript. Simply type it in, and paste in one of my scripts, after the colon. Then, do as it says!<br>
<br>You can also do this in bookmarks. Create a new bookmark and make it say <br>``javascript:``<br> and have the script after it!
<br>----------------------------------------------------------------------------------------------------------------------<br>
# ---------Info
